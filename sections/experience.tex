...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item Created a wireless digital crack monitoring system for structural health monitoring. This system will replace the traditional crack gauges and eliminates the need for constant surveillance.
      \end{cvitems}
    }
  %\cventry
